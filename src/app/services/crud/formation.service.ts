...
export class FormationService {
  ...
  getDescriptionDetaillee(formationId: number): string {
    const descriptions: { [key: number]: string } = {
      1: `Formation intensive axée sur les **TECHNOLOGIES FRONT-END MODERNES**.

    Vous apprendrez à créer des interfaces utilisateur interactives et responsives en utilisant _HTML5, CSS3, JavaScript ES6+_ et **React**.
    ...
    **DURÉE :** 500 heures sur 4 mois | **NIVEAU REQUIS :** Bac+2 minimum
    ...
    À l'issue de cette formation, vous serez capable de développer des applications web modernes et de collaborer efficacement en équipe.`,
      ...
      2: `Formation spécialisée dans le **DÉVELOPPEMENT CÔTÉ SERVEUR** avec Node.js et Express.

    Vous maîtriserez la création d'_APIs REST_, la gestion des bases de données (**MySQL, MongoDB**) et l'authentification.
    ...
    **PARFAITE POUR :** ceux qui souhaitent devenir développeurs back-end ou full-stack.
    ...
    **DÉBOUCHÉS :** Développeur back-end, Architecte logiciel, DevOps junior.`,
      ...
      3: `Formation complète alliant **FRONT-END ET BACK-END** pour devenir développeur polyvalent.

    Vous développerez des applications web **DE A À Z** en utilisant _React, Node.js_, et les bases de données relationnelles.
    ...
    **Certification professionnelle incluse** | **Taux d'insertion professionnelle : 95%**.`,
      ...
      4: `Formation dédiée à la **SÉCURITÉ DES INFRASTRUCTURES INFORMATIQUES**.

    Vous apprendrez à configurer des _firewalls_, analyser les vulnérabilités réseau et mettre en place des solutions de **monitoring**.
    ...
    **DÉBOUCHÉS :** Administrateur sécurité, Analyste SOC, Consultant en cybersécurité.`,
      ...
      5: `Formation avancée aux **TECHNIQUES D'INTRUSION ÉTHIQUE** et d'audit de sécurité.

    Vous maîtriserez les _outils de pentest_, l'analyse de vulnérabilités et la rédaction de rapports d'audit.
    ...
    **Certification éthique OBLIGATOIRE** | **DÉBOUCHÉS :** Pentester, Consultant sécurité, Expert cybersécurité.`,
      ...
      6: `Formation spécialisée dans l'**ÉCOSYSTÈME JAVA ENTERPRISE** avec Spring Boot.

    Vous développerez des applications web **robustes, sécurisées et scalables** pour l'entreprise.

    Le programme inclut _Spring Security, JPA/Hibernate_, les **microservices** et l'intégration avec des bases de données complexes.
    ...
    **Partenariat avec des entreprises locales** pour stages et projets réels.`,
      ...
      7: `Formation experte en **CYBERDÉFENSE ET GESTION DE SOC** (Security Operations Center).

    Vous apprendrez à détecter, analyser et répondre aux **cyberattaques en temps réel**.

    Le programme couvre les _SIEM_, l'analyse forensique, la **threat intelligence** et la coordination des équipes de sécurité.
    ...
    **Certification ANSSI possible** | **DÉBOUCHÉS :** Responsable SOC, Analyste cybersécurité, RSSI adjoint.`,
      ...
      8: `Formation pratique au **DÉVELOPPEMENT WEB AVEC PHP** et le framework Laravel.

    Vous créerez des applications web dynamiques, des _APIs_ et des systèmes de **gestion de contenu**.
    ...
    **Laravel étant très demandé**, excellent taux d'employabilité dans les PME et startups.`,
      ...
      9: `Formation spécialisée dans la **SÉCURISATION DES APPLICATIONS WEB**.

    Vous identifierez et corrigerez les _vulnérabilités OWASP_, implémenterez des mécanismes de protection robustes.
    ...
    **Certification sécurité incluse** | Profil **très recherché** par les entreprises sensibles à la cybersécurité.`,
      ...
      10: `Formation d'introduction complète à la **CYBERSÉCURITÉ POUR DÉBUTANTS**.

    Vous découvrirez les _fondamentaux de la sécurité informatique_, les principales menaces et les bonnes pratiques.
